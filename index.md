...
Due to the overwhelming interest in using Thunder the Robot to introduce programming and algorithmic thinking, H. Paul Haiduk is now working on a book (along with problems and suggested solutions) to accompany this software.  Plans are to complete the book by December 2017.
